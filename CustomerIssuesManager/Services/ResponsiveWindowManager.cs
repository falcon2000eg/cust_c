...
namespace CustomerIssuesManager.Services
{
    ...
    {
        private static ResponsiveWindowManager _instance = null!;
        private static readonly object _lock = new object();
        private readonly ResponsiveDesignService _responsiveService;

        public static ResponsiveWindowManager Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    {
                        if (_instance == null)
                            _instance = new ResponsiveWindowManager();
                    }
                }
                return _instance;
            }
        ...
        private ResponsiveWindowManager()
        {
            _responsiveService = ResponsiveDesignService.Instance;
        }

        public void SetupResponsiveWindow(Window window)
        {
            try
            {
                ...
                // Apply initial responsive design
                ApplyResponsiveDesignToWindow(window);

                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Setup responsive window {window.Title}");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error setting up responsive window: {ex.Message}");
            }
        }
        ...
        private void Window_SizeChanged(object? sender, SizeChangedEventArgs e)
        {
            ...
            {
                AdaptLayoutToWindowSize(window, e.NewSize);
            }
        }
        ...
        private void ApplyResponsiveDesignToWindow(Window window)
        {
            try
            {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error applying responsive design: {ex.Message}");
            }
        }
        ...
        private void ApplyResponsiveDesignToControls(Window window)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error applying responsive design to controls: {ex.Message}");
            }
        }
        ...
        private void SetupResponsiveLayout(Window window)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error setting up responsive layout: {ex.Message}");
            }
        }

        private void AdaptLayoutToWindowSize(Window window, System.Windows.Size newSize)
        {
            try
            {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error adapting layout to size: {ex.Message}");
            }
        }
        ...
        private void AdaptLayoutToWindowState(Window window)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error adapting layout to window state: {ex.Message}");
            }
        }
        ...
        private void SwitchToCompactLayout(Window window)
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Switched to compact layout for {window.Title}");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error switching to compact layout: {ex.Message}");
            }
        }
        ...
        private void SwitchToExpandedLayout(Window window)
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Switched to expanded layout for {window.Title}");
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error switching to expanded layout: {ex.Message}");
            }
        }
        ...
        private void UpdateControlSizes(Window window, System.Windows.Size windowSize)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ResponsiveWindowManager: Error updating control sizes: {ex.Message}");
            }
        }
